...
def readExr_old(path : str, channels = ['R', 'G', 'B'], transposed = True, device = 'cpu') -> t.tensor:
...
def saveExrOld(pic, path : str, channels = ['R', 'G', 'B'], transposed = False):
